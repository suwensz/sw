  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'sell', name: 'Sell', component: () => import('@/views/shop/SellPage.vue'), meta: { group: 'commerce' } },
        ...
        { path: 'ops/logistics', name: 'Logistics', component: () => import('@/views/ops/LogisticsPage.vue'), meta: { group: 'commerce' } },
        { path: 'ops/returns', name: 'Returns', component: () => import('@/views/ops/ReturnsPage.vue'), meta: { group: 'commerce' } },
        { path: 'ops/return-policy', name: 'ReturnPolicy', component: () => import('@/views/ops/ReturnPolicyPage.vue'), meta: { group: 'commerce' } },
        { path: 'ops/procurement', name: 'Procurement', component: () => import('@/views/ops/ProcurementPage.vue'), meta: { group: 'commerce' } },
        { path: 'ops/my-orders', name: 'MyOrders', component: () => import('@/views/ops/MyOrdersPage.vue'), meta: { group: 'commerce' } },
        { path: 'ops/distribute', name: 'Distribute', component: () => import('@/views/ops/DistributePage.vue'), meta: { group: 'commerce' } },

        // 国内电商组（卖家角色）
        { path: 'domestic/dashboard', name: 'DomesticDashboard', component: () => import('@/views/domestic/SellerDashboardPage.vue'), meta: { group: 'domestic' } },
        { path: 'domestic/products', name: 'DomesticProducts', component: () => import('@/views/domestic/ProductManagePage.vue'), meta: { group: 'domestic' } },
        { path: 'domestic/orders', name: 'DomesticOrders', component: () => import('@/views/domestic/OrderManagePage.vue'), meta: { group: 'domestic' } },
