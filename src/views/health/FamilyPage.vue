...
// 关系显示：预设关系走 i18n，自定义关系（如：爷爷、外婆、岳母）原样显示
        ...
        >
          ...
          <div class="member-info">
            ...
            <span class="member-meta">
              {{ relationshipLabel(m.relationship) }} · {{ localizeNumber(calcAge(m.birthDate), locale) }}{{ t('family.age') }}
            </span>
        ...
        <div class="detail-header">
          ...
          <div class="detail-title">
            ...
            <div class="detail-tags">
              <el-tag>{{ relationshipLabel(health.selectedMember.relationship) }}</el-tag>
    ...
    <el-dialog v-model="showDialog" :title="editingId ? t('family.editMember') : t('family.addMember')" width="520px">
      <el-form :model="form" label-position="top" class="member-form">
        ...
        <el-form-item :label="t('family.relationship')">
          ...
          <div class="form-hint">{{ t('family.relationshipHint') }}</div>
        </el-form-item>
